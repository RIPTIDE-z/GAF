...
struct GAFINPUT_API FGAFInputSettings
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "LookSettings|Mouse", meta = (ClampMin = "1.0", ClampMax = "10.0", UIMin = "1.0", UIMax = "10.0"))
	...
	// 代表每秒旋转度数
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "LookSettings|Gamepad", meta = (ClampMin = "1.0", ClampMax = "720.0", UIMin = "1.0", UIMax = "720.0", ForceUnits = "deg/s"))
