...
namespace GAFInput
{
	...
	void BindNativeAction(UEnhancedInputComponent* EnhancedInput, const UGAFInputConfig* InputConfig, const FGameplayTag& InputTag,
	                      const ETriggerEvent TriggerEvent, UserClass* Object, FuncType Func, const bool bLogIfNotFound = true)
	{
